      ...
      <div class="col-md-10">
          <div class="panel panel-default">
              <div class="panel-heading">
                  <h3 class="panel-title"><strong>Actualizar información: <b>{{$user->nombres}} {{$user->apellidos}}</b> </strong> </h3>
                  @if( isset($_GET['msj']))
              ...
              <div class="panel-body">
                {!! Form::model($user, ['action'=>'UsuarioController@profileActulizar', 'method'=>'POST', 'id'=>'form-create', 'class'=>'form-horizontal', 'role'=>'form' ])!!}
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-6">
                        {!! Form::select('grupo_id', ['1'=>'Administrador', '2'=>'Administración Clinica', '3'=>'Contabilidad'], null, ['id'=>'grupo_id', 'class'=>'form-control']) !!}
                      </div>
                  </div>
